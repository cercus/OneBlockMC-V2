...
public class SetWarpCommand implements SubCommand {
    ...
    public String getPermission() {
        return "oneblockmc.player.setwarp";
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if(args.length == 1) {
            ...
            IslandUtils.modifyWarp(is.get(), player.getLocation());
            MessageUtil.sendMessage(player.getUniqueId(), OneBlockMC.getMessages().get("success_setwarp"));
    ...
    public String getDescription() {
        return OneBlockMC.getMessages().get("command_setwarp_description");
    }
    ...
    public String getSyntax() {
        return OneBlockMC.getMessages().get("command_setwarp_syntax");
    }
}
